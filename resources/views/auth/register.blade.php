                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-2 text-center">
                            <h3>{{ __('Личная информация') }}</h3>
                        </div>
                        <div class="row mb-3">
                            <label for="first_name" class="col-md-4 col-form-label text-md-end">{{ __('Имя') }}</label>

                            <div class="col-md-6">
                                <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" required autocomplete="given_name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ old('surname') }}" required autocomplete="additional_name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="patronymic" type="text" class="form-control @error('patronymic') is-invalid @enderror" name="patronymic" value="{{ old('patronymic') }}" required autocomplete="family_name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="skills" id="skills" cols="30" rows="5" class="form-control @error('skills') is-invalid @enderror" required>{{ old('skills') }}</textarea>
